...
namespace Puello_WindowsAssigment
{
    ...
    public class Person
    {
        ...
        //This is for the public string to be used as feedback to the consele
        ...
        public string MiddleN 
        {
            ...
            set
            {
                ...
                {
                    feedback += "ERROR: Please enter your middle name.\n";
                }
            }
        }
        ...
        public string FirstS 
        {
            ...
            set
            {
                ...
                {
                    feedback += "ERROR: Please enter street's name.\n";
                }
            }
        }
        ...
        public string City 
        {
            ...
            set
            {
                ...
                if (ValidationLibrary.CheckingForLength(value, 5))
                {
                    city = value;
                }
                else
        ...
        public string State 
        {
            ...
            set
            {
                ...
                if (ValidationLibrary.CheckingForLength(value, 2))
                {
                    state = value;
                }
                else
                {
                    feedback += "ERROR: Enter the two capital letters of your state.\n";
                }
            }
        }
        ...
        public string Zip 
        {
            ...
            set
            {
                ...
                {
                    feedback += "ERROR: Enter Your 5 zip code numbers \n";
                }
            }
        ...
        //New variable name for the user's phone number.
        public string PhoneN 
        {
            ...
            set
            {
                //This is a function so the answer is not null and is filled out with 10 numbers.
                ...
                {
                    feedback += "ERROR: Enter Your 10 digit Phone.\n";
                }

            }
        }
        //New variable name for the user's email.
        public string Email 
        {
            get
            {
