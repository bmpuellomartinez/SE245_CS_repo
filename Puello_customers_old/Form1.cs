...
namespace Puello_WindowsAssigment
{
    public partial class Form1 : Form
    {
        ...
        private void feedbackbutton_Click(object sender, EventArgs e)
        {
            ...
            person.Cellphone = txtPnumber.Text; 
            person.Email = txtEmail.Text;
            person.Discount = chkDiscountM.Checked;
            person.CustomerSince = calCustomerSince.Value;
         
         
            //comverting the txtTotal to a double so it is read it as a double.
            ...
            {
                person.feedback += "ERROR: The total amount of money\n";  
            }
            ...
            {
                person.feedback += "ERROR: The enter awards.";
            }
            ...
            {
                person.feedback += "ERROR: Enter the 5 zip numbers";
            }

            //This will make sure that the user enter only numbers
            if(int.TryParse(txtPnumber.Text, out personTotal))
            {
                person.Cellphone = txtPnumber.Text;
            }
            else
            {
                person.feedback += "ERROR: Enter the 10 digit numbers.";
            }
